...
void CSpriteManager::Add(string id, RECT rect, LPDIRECT3DTEXTURE9 tex, D3DXVECTOR2 pointCenter)
{
	LPSprite s = new CSprite(id, rect, tex, pointCenter);
