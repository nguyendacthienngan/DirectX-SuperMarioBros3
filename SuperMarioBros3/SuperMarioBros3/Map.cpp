...
CMap::CMap(std::string filePath, std::string fileName)
{
	//LoadMap(filePath);
	
	LoadTilemap(filePath, fileName);
}
...
void CMap::LoadTilemap(std::string filePath, std::string fileName)
{
	tileMap = new CTileMap();
	CTileMap::FromTMX(filePath, fileName);
}
